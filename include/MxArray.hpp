...
class MxArray
{
  public:
    ...
    cv::Mat toMat(int depth, bool transpose = true) const;
     ...
     * @endcode
     */
    cv::MatND toMatND() const;

    cv::MatND toMatND(int depth, bool transpose = true) const;
     ...
     */
    cv::SparseMat toSparseMat(int depth) const;
